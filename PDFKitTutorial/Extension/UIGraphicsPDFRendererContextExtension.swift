//
//  UIGraphicsPDFRendererContextExtension.swift
//  PDFKitTutorial
//
...
extension UIGraphicsPDFRendererContext {
    ...
    func addCenteredText(fontSize: CGFloat, weight: UIFont.Weight, text: String, cursor: CGFloat, pdfSize: CGSize) -> CGFloat {
